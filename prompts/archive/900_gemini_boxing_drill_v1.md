...
TASK:
1. Analyze the attached training video only for the focus area specified using the "Professional Standard" scoring system below.
2. Only provide scores and commentary for the specific focus area.  Omit all other scores and comments.
...
"session_analysis": {
    ...
    "coaching_summary": "<A string containing detailed, professional advice based on the scores and observed video mechanics. advice and mistakes should be specific to the focus area. be to the point, no added personality.>",
    "key_mistakes": [ "<A bulleted list that is to the point.>"
